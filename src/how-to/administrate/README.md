...
* [Operational procedures](operations.md)
  ...
  * [Draining pods from a node for maintainance](operations.md#draining-pods-from-a-node-for-maintainance)
...
* [Investigative tasks (e.g. searching for users as server admin)](users.md)
  ...
  * [How to manually search for a user on elasticsearh directly (not recommended)](users.md#how-to-manually-search-for-a-user-on-elasticsearh-directly-not-recommended)
